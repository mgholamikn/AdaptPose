...
def plot_poseaug(inputs_3d, inputs_2d, g_rlt, cam_param, epoch, iter, args):
    pad=(g_rlt['pose_ba'].shape[1]-1)//2
    outputs_3d_ba = g_rlt['pose_ba'][:,pad]
    outputs_3d_bl = g_rlt['pose_bl'][:,pad]
    outputs_3d_rt = g_rlt['pose_rt'][:,pad]
    # print('outputs_3d_ba',outputs_3d_ba.shape)
